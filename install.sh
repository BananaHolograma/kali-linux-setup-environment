...
function setupInfoSecTools() {
    ...
    sudo apt install -y firejail python3 python3-pip tor sqlmap dnsrecon wafw00f burpsuite whois amass massdns golang-go masscan nmap brutespray ffuf exploitdb
