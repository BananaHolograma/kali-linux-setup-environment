...
function prepareEnvironmentForTheInstallation() {
    ...
    sudo apt upgrade -y && sudo apt install -y grc net-tools iputils-ping socat cifs-utils tldr awscli docker.io docker-compose rsync parallel mongodb-clients freerdp2-x11
}
